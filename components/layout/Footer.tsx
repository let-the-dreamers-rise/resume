        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-foreground/70 max-w-xs">
              A modern portfolio showcasing Frontend Engineering, Machine Learning, and Generative AI expertise.
            </p>
          </div>
            ...
            <ul className="mt-4 space-y-3">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-foreground/70 hover:text-primary transition-colors duration-normal"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="mt-4 flex space-x-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="text-foreground/70 hover:text-primary transition-colors duration-normal"
        ...
        <div className="mt-12 border-t border-border/40 pt-8">
          <div className="flex justify-center">
            <p className="text-sm text-foreground/70">
              © {currentYear} Ashwin Goyal Portfolio. All rights reserved.
            </p>
          </div>
        </div>
      </div>
